...
import { infoExample, pluginExample, validationExample } from "@/examples"
import { useState } from "react"

export default function About() {
    const [code, setCode] = useState(pluginExample)
            ...
            <div className="container mx-auto py-5 pb-20">
                <div className="grid grid-cols-2 gap-5 ">
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="backdrop-blur-sm bg-white/10 w-full border rounded-md xl:text-lg border-white/40 p-4 flex gap-4 items-center border-box col-span-1 cursor-pointer" onClick={() => setCode(pluginExample)}>
                            <div>
                        ...
                        <div className="backdrop-blur-sm bg-white/10 w-full border rounded-md xl:text-lg border-white/40 p-4 flex gap-4 items-center border-box col-span-1 cursor-pointer" onClick={() => setCode(validationExample)}>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#111827" className="w-8 h-8">
                        ...
                        <div className="backdrop-blur-sm bg-white/10 w-full border rounded-md xl:text-lg border-white/40 p-4 flex gap-4 items-center border-box col-span-1 cursor-pointer" onClick={() => setCode(infoExample)}>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#111827" className="w-8 h-8">
